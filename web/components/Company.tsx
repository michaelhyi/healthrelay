  ...
  return (
    ...
    >
      <Fade up distance="20px" delay={200}>
        <div className="font-poppins font-bold lg:text-5xl xl:text-6xl text-400">
          Our Company
        </div>
        <div className="font-poppins font-medium lg:text-sm text-center w-[50vh] text-gray mt-6">
      ...
      <Fade up distance="20px" delay={300}>
        <div className="flex lg:space-x-8 xl:space-x-16 mt-24">
          {company.map((v) => (
            <Founder data={v} />
          ))}
        </div>
