      ...
      <Fade up distance="25px" delay={750}>
        ...
        <div className="flex space-x-8 mt-8">
          <Link
            ...
            duration={1000}
          >
            <button className="flex justify-center items-center bg-300 rounded-xl sm:h-[50px] sm:w-[187.5px] lg:h-[60px] lg:w-[225px] hover:cursor-pointer duration-300 hover:bg-200 font-poppins font-medium sm:text-sm lg:text-base text-white text-center">
          ...
          <Link
            ...
            duration={1000}
          >
            <button className="flex justify-center items-center bg-white drop-shadow-xl rounded-xl sm:h-[50px] sm:w-[187.5px] lg:h-[60px] lg:w-[225px] hover:cursor-pointer duration-300 hover:bg-[#F2F2F2] font-poppins font-medium sm:text-sm lg:text-base text-300">
              Schedule A Demo
            </button>
          </Link>
        </div>
